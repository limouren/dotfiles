...
let
  ...
  pkgs = import
    (fetchTarball {
      name = "nixos-unstable-2023-10-16";
      url = "https://github.com/NixOS/nixpkgs/archive/ca012a02bf83.tar.gz";
      # Hash obtained using `nix-prefetch-url --unpack <url>`
      sha256 = "1nlxb2jldq51mnb0japs5pqi82msrginm0kjhsgbzrlvpag9525f";
    })
    {
